...
//         params.bands[0].setGainWithIndex(0, 6.0);
//         params.bands[1].setGainWithIndex(1, 0.0);
//         params.bands[2].setGainWithIndex(2, 0.0);
//         params.bands[3].setGainWithIndex(3, 0.0);
//         params.bands[4].setGainWithIndex(4, 6.0);
//       }
//       // _state.isSetGain.value = true;
//     }else if(genre == 'Rock'){
//       for(var i = 0; i < params.bands.length; i++){
//         params.bands[0].setGainWithIndex(0, 11.0);
//         params.bands[1].setGainWithIndex(1, 9.0);
//         params.bands[2].setGainWithIndex(2, 2.0);
//         params.bands[3].setGainWithIndex(3, 10.0);
//         params.bands[4].setGainWithIndex(4, 12.0);
//       }
//       // _state.isSetGain.value = true;
//     }
//     // else if(_state.genreEqualizer.value == 'Classical'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, 9.0);
//     //     params.bands[1].setGainWithIndex(1, 7.0);
//     //     params.bands[2].setGainWithIndex(2, 0.0);
//     //     params.bands[3].setGainWithIndex(3, 8.0);
//     //     params.bands[4].setGainWithIndex(4, 8.0);
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'Dance'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, 10.0);
//     //     params.bands[1].setGainWithIndex(1, 0.0);
//     //     params.bands[2].setGainWithIndex(2, 3.0);
//     //     params.bands[3].setGainWithIndex(3, 5.0);
//     //     params.bands[4].setGainWithIndex(4, 1.0);
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'Folk'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, 5.0);
//     //     params.bands[1].setGainWithIndex(1, 0.0);
//     //     params.bands[2].setGainWithIndex(2, 0.0);
//     //     params.bands[3].setGainWithIndex(3, 0.2);
//     //     params.bands[4].setGainWithIndex(4, -0.2);
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'Heavy Metal'){
//     //   for(var i = 0; i < params.bands.length; i++){
...
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'Hip Hop'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, 7.0);
//     //     params.bands[1].setGainWithIndex(1, 5.0);
//     //     params.bands[2].setGainWithIndex(2, 2.0);
//     //     params.bands[3].setGainWithIndex(3, 3.0);
//     //     params.bands[4].setGainWithIndex(4, 4.0);
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'Jazz'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, 8.0);
//     //     params.bands[1].setGainWithIndex(1, 6.0);
//     //     params.bands[2].setGainWithIndex(2, 0.0);
//     //     params.bands[3].setGainWithIndex(3, 7.0);
//     //     params.bands[4].setGainWithIndex(4, 9.0);
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'Pop'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, -0.2);
//     //     params.bands[1].setGainWithIndex(1, 0.0);
//     //     params.bands[2].setGainWithIndex(2, 5.0);
//     //     params.bands[3].setGainWithIndex(3, -0.0);
//     //     params.bands[4].setGainWithIndex(4, -0.5);
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'Rock'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, 11.0);
//     //     params.bands[1].setGainWithIndex(1, 9.0);
//     //     params.bands[2].setGainWithIndex(2, 2.0);
...
//     //   }
//     //   _state.isSetGain.value = true;
//     // }else if(_state.genreEqualizer.value == 'FX Booster'){
//     //   for(var i = 0; i < params.bands.length; i++){
//     //     params.bands[0].setGainWithIndex(0, 0.0);
//     //     params.bands[1].setGainWithIndex(1, 12.0);
//     //     params.bands[2].setGainWithIndex(2, 9.0);
//     //     params.bands[3].setGainWithIndex(3, 2.0);
//     //     params.bands[4].setGainWithIndex(4, 14.0);
//     //   }
//     //   _state.isSetGain.value = true;
//     // }
//   }
